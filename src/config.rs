...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rust.dongdao.link"];
pub const RS_PUB_KEY: &str = "0VF07m4tYMx4riwCYlHa0P4HP6NiOxYD7qy8w8UiYZM=";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "https://rust.dongdao.link";
